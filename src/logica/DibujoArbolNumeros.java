 ...
 * @author Nicolas
 */
public class DibujoArbolNumeros extends Canvas {

    private ArbolNumeros arbol;
    private int radio = 13;
    private int vGap = 40;

    public DibujoArbolNumeros(ArbolNumeros arbol) {
        this.arbol = arbol;
    }
    ...
    private void dibujarArbol(Graphics g, NodoNumeros nodo, int x, int y, int hGap) {
        if (nodo != null) {
            g.setColor(Color.BLACK);
